...
#checking if number of species is correct, WIP
...
lucerne_subset <- abu_nets_df_final |> 
  filter(Lake %in% "Lucerne") |> 
  filter(Species %in% c("Alburnus_alburnus", "Coregonus_sp", "Coregonus_zugensis", "Cottus_gobio_Profundal_Lucerne", "Gymnocephalus_cernua", "Leuciscus_leuciscus", "Lota_lota", "Perca_fluviatilis", "Rutilus_rutilus", "Lucerne_Salvelinus_sp_Profundal_dwarf_VWS", "Salvelinus_umbla", "Tinca_tinca"))

lugano_subset <- abu_nets_df_final |> 
  filter(Lake %in% "Lugano") |> 
  filter(Species %in% c("Alburnu_arborella", "Coregonus_helveticus", "Lota_lota", "Micropterus_salmoides", "Perca_fluviatilis", "Rutilus_rutilus", "Sander_lucioperca", "Scardinius_hesperidicus", "Squalius_squalus"))
