...
lucerne_subset <- abu_nets_df_final |> 
  ...
  filter(Species %in% c("Alburnus_alburnus", "Coregonus_intermundia", "Coregonus_sp", "Coregonus_zugensis", "Cottus_gobio_Aare_littoral", "Gymnocephalus_cernua", "Lota_lota", "Perca_fluviatilis", "Rutilus_rutilus", "Salvelinus_sp_Profundal_dwarf_VWS", "Salvelinus_umbla", "Sander_lucioperca"))
...
maggiore_subset <- abu_nets_df_final |> 
  ...
  filter(Species %in% c("Alburnus_arborella", "Alosa_agone", "Ameiurus_melas", "Coregonus_sarnensis", "Coregonus_sp", "Gymnocephalus_cernua", "Lepomis_gibbosus", "Lota_lota", "Perca_fluviatilis", "Rutilus_rutilus", "Salmo_trutta", "Sander_lucioperca", "Scardinius_hesperidicus"))
...
neuchatel_subset <- abu_nets_df_final |> 
  ...
  filter(Species %in% c("Alburnus_alburnus", "Cobitis_bilineata", "Coregonus_candidus", "Coregonus_palaea", "Coregonus_sp", "Cottus_gobio_Aare_littoral", "Esox_lucius", "Gobio_gobio", "Lota_lota", "Perca_fluviatilis", "Rutilus_rutilus", "Scardinius_erythrophthalmus", "Squalius_cephalus"))
...
zug_subset <- abu_nets_df_final |> 
  filter(Lake %in% "Zug") |> 
  filter(Species %in% c("Alburnus_alburnus", "Coregonus_sp", "Cyprinus_carpio", "Gobio_gobio", "Gymnocephalus_cernua", "Lepomis_gibbosus", "Leuciscus_leuciscus", "Perca_fluviatilis", "Rutilus_rutilus", "Salvelinus_umbla", "Scardinius_erythrophthalmus", "Squalius_cephalus"))
...
#checking if number of species is correct, Konstanz, Lucerne, Maggiore, Neuchatel, Walen something wrong
...
for (i in sub_lakes){
  ...
  for (j in species_list){ #looping through all species occuring in this lake
    ...
    # print(summary)
    # sink()
    model_prediction[[j]] <- predict.gam(gam_output[[j]], temp_gradient, type = "response", se.fit = TRUE)$fit #saving model predictions in RDS, add
    ...
    # confidence_intervall[[j]] <- predict.gam(gam_output[[j]], temp_gradient, type = "response", se.fit = TRUE)$se, need to look at predict functions of gams
...
biel_subset <- abu_nets_df_final |> 
  filter(Lake %in% "Biel") |> 
  filter(Species %in% c("Blicca_bjoerkna", "Coregonus_confusus", "Coregonus_sp", "Leuciscus_leuciscus", "Lota_lota", "Perca_fluviatilis", "Rutilus_rutilus", "Scardinius_erythrophthalmus", "Scardinius_hesperidicus", "Squalius_cephalus")) #blicca graubereich

brienz_subset <- abu_nets_df_final |> 
  filter(Lake %in% "Brienz") |> 
  filter(Species %in% c("Alburnus_alburnus", "Coregonus_albellus", "Coregonus_fatioi", "Coregonus_sp", "Leuciscus_leuciscus", "Lota_lota", "Perca_fluviatilis", "Rutilus_rutilus"))

constance_subset <- abu_nets_df_final |> 
  filter(Lake %in% "Constance") |> 
  filter(!Species %in% c("Barbus_barbus", "Coregonus_arenicolus", "Esox_lucius", "Gobio_obtusirostris", "Oncorhynchus_mykiss", "Salvelinus_profundus"))

geneva_subset <- abu_nets_df_final |> 
  filter(Lake %in% "Geneva") |>
  filter(!Species %in% c("Gasterosteus_gymnurus", "Salaria_fluviatilis_French"))
...
lucerne_subset <- abu_nets_df_final |> 
  filter(Lake %in% "Lucerne") |> 
  filter(Species %in% c("Alburnus_alburnus", "Coregonus_sp", "Coregonus_zugensis", "Cottus_gobio_Profundal_Lucerne", "Gymnocephalus_cernua", "Leuciscus_leuciscus", "Lota_lota", "Perca_fluviatilis", "Rutilus_rutilus", "Salvelinus_sp_Profundal_dwarf_VWS", "Salvelinus_umbla", "Tinca_tinca"))

lugano_subset <- abu_nets_df_final |> 
  filter(Lake %in% "Lugano") |> 
  filter(Species %in% c("Alburnus_arborella", "Coregonus_helveticus", "Lota_lota", "Micropterus_salmoides", "Perca_fluviatilis", "Rutilus_rutilus", "Sander_lucioperca", "Scardinius_hesperidicus", "Squalius_squalus"))
  
maggiore_subset <- abu_nets_df_final |> 
  filter(Lake %in% "Maggiore") |> 
  filter(Species %in% c("Alburnus_arborella", "Alosa_agone", "Ameiurus_melas", "Coregonus_sarnensis", "Coregonus_sp", "Cottus_sp_Po_profundal", "Gymnocephalus_cernua", "Lepomis_gibbosus", "Lota_lota", "Micropterus_salmoides", "Perca_fluviatilis", "Rutilus_aula", "Rutilus_rutilus", "Salmo_trutta", "Sander_lucioperca", "Scardinius_hesperidicus", "Squalius_squalus", "Telestes_muticellus"))

morat_subset <- abu_nets_df_final |> 
  filter(Lake %in% "Morat") |> 
  filter(Species %in% c("Abramis_brama", "Alburnus_alburnus", "Leuciscus_leuciscus", "Perca_fluviatilis", "Rutilus_rutilus", "Salmo_trutta", "Sander_lucioperca", "Scardinius_erythrophthalmus", "Squalius_cephalus", "Tinca_tinca"))

neuchatel_subset <- abu_nets_df_final |> 
  filter(Lake %in% "Neuchatel") |> 
  filter(Species %in% c("Barbatula_sp_Lineage_I", "Cobitis_bilineata", "Coregonus_candidus", "Coregonus_palaea", "Coregonus_sp", "Cottus_gobio_Aare_littoral", "Esox_lucius", "Gobio_gobio", "Leuciscus_leuciscus", "Lota_lota", "Perca_fluviatilis", "Rutilus_rutilus", "Scardinius_erythrophthalmus", "Scardinius_hesperidicus", "Squalius_cephalus", "Tinca_tinca"))

poschiavo_subset <- abu_nets_df_final |> 
  filter(Lake %in% "Poschiavo") |> 
  filter(Species %in% c("Phoxinus_sp", "Salmo_sp_Blackspot", "Salmo_trutta", "Salvelinus_umbla"))

sarnen_subset  <- abu_nets_df_final |> 
  filter(Lake %in% "Sarnen") |> 
  filter(Species %in% c("Alburnus_alburnus", "Barbus_barbus", "Coregonus_litoralis", "Coregonus_sarnensis", "Cottus_gobio_unknownlineage", "Gymnocephalus_cernua", "Leuciscus_leuciscus", "Lota_lota", "Perca_fluviatilis", "Rutilus_rutilus", "Scardinius_erythrophthalmus", "Squalius_cephalus"))

thun_subset  <- abu_nets_df_final |> 
  filter(Lake %in% "Thun") |> 
  filter(Species %in% c("Alburnus_alburnus", "Barbus_barbus", "Coregonus_acrinasus", "Coregonus_albellus", "Coregonus_brienzii", "Coregonus_fatioi", "Coregonus_profundus", "Cottus_gobio_Profundal_Thun", "Leuciscus_leuciscus", "Lota_lota", "Perca_fluviatilis", "Phoxinus_csikii", "Rutilus_rutilus", "Salvelinus_sp_Limnetic_Thun", "Salvelinus_umbla", "Squalius_cephalus"))

walen_subset  <- abu_nets_df_final |> 
  filter(Lake %in% "Walen") |> 
  filter(Species %in% c("Alburnus_alburnus", "Coregonus_sp", "Cottus_gobio_Aare_littoral", "Cottus_gobio_Profundal_Walen", "Esox_lucius", "Leuciscus_leuciscus", "Lota_lota", "Perca_fluviatilis", "Rutilus_rutilus", "Salvelinus_sp_Profundal_Walen_I", "Salvelinus_umbla", "Squalius_cephalus"))

zug_subset  <- abu_nets_df_final |> 
  filter(Lake %in% "Zug") |> 
  filter(Species %in% c("Alburnus_alburnus", "Coregonus_sp", "Cyprinus_carpio", "Gobio_gobio", "Gymnocephalus_cernua", "Lepomis_gibbosus", "Leuciscus_leuciscus", "Lota_lota", "Perca_fluviatilis", "Rutilus_rutilus", "Scardinius_erythrophthalmus", "Squalius_cephalus", "Tinca_tinca"))

zurich_subset  <- abu_nets_df_final |> 
  filter(Lake %in% "Zurich") |> 
  filter(Species %in% c("Abramis_brama", "Alburnus_alburnus", "Coregonus_duplex", "Coregonus_heglingus", "Coregonus_sp", "Coregonus_zuerichensis", "Esox_lucius", "Gobio_gobio", "Gymnocephalus_cernua", "Lepomis_gibbosus", "Leuciscus_leuciscus", "Lota_lota", "Perca_fluviatilis", "Rutilus_rutilus", "Salvelinus_umbla", "Scardinius_erythrophthalmus", "Squalius_cephalus" ))

df_subset_depth <- bind_rows(biel_subset, brienz_subset, constance_subset, geneva_subset, joux_subset, lucerne_subset, lugano_subset, maggiore_subset, morat_subset, neuchatel_subset, poschiavo_subset, sarnen_subset, thun_subset, walen_subset, zug_subset, zurich_subset)

#check if subset is correct, correct! if correct from .txt
...
for (i in sub_lakes){
  ...
  for (j in species_list){ #looping through all species occuring in this lake
    ...
    saveRDS(model_bind, paste0("Subset_depth/predictions_abundance/predictions_",i,"_",j,".rds"))
    derivatives[[j]] <- derivatives(gam_output[[j]]) #making derivatives and saving them in a RDS
    saveRDS(derivatives[[j]], paste0("Subset_depth/derivatives_abundance/derivatives_",i,"_",j,".rds"))
  }
...
path_pred <- "/home/sophie/Dokumente/Master Thesis R/response-diversity-in-swiss-lakes/Subset_depth/predictions_abundance"
...
for (i in sub_lakes){
  ...
  for (j in predictions_lakes){
    ...
    df_pred <- pred |>
      ...
      mutate(Species = sub("^[^_]*_", "", Species)) |>
      mutate(Species = sub("\\.rds$", "", Species))
    saveRDS(df_pred, paste0("Subset_depth/df_predictions_abundance/df_pred_", i, ".rds"))
      
  }
}

# derivatives
path_deriv <- "/home/sophie/Dokumente/Master Thesis R/response-diversity-in-swiss-lakes/Subset_depth/derivatives_abundance"
...
for (i in sub_lakes){
  ...
  for (j in deriv_lakes){
    ...
    df_deriv <- deriv |>
      ...
      mutate(Species = sub("^[^_]*_", "", Species)) |>
      mutate(Species = sub("\\.rds$", "", Species))
    saveRDS(df_deriv, paste0("Subset_depth/df_derivatives_abundance/df_deriv_", i, ".rds"))
  }
}
...
for (i in sub_lakes){
  ...
  for (j in deriv_lakes){
    ...
    df_resp_div$sign <- apply(df_resp_div[,-1, drop = FALSE], 1, resp_div, sign_sens = T)
    df_resp_div$Med <- median(df_resp_div$rdiv)
    saveRDS(df_resp_div, paste0("Subset_depth/df_response_diversity_abundance/df_resp_div_", i, ".rds"))
  }
}
...
```{r}
df_biel_pred <- readRDS("Subset_depth/df_predictions_abundance/df_pred_Biel.rds")
df_biel_deriv <- readRDS("Subset_depth/df_derivatives_abundance/df_deriv_Biel.rds")
df_biel_resp_div <- readRDS("Subset_depth/df_response_diversity_abundance/df_resp_div_Biel.rds")
...
```{r}
df_brienz_pred <- readRDS("Subset_depth/df_predictions_abundance/df_pred_Brienz.rds")
df_brienz_deriv <- readRDS("Subset_depth/df_derivatives_abundance/df_deriv_Brienz.rds")
df_brienz_resp_div <- readRDS("Subset_depth/df_response_diversity_abundance/df_resp_div_Brienz.rds")
...
```{r}
df_constance_pred <- readRDS("Subset_depth/df_predictions_abundance/df_pred_Constance.rds")
df_constance_deriv <- readRDS("Subset_depth/df_derivatives_abundance/df_deriv_Constance.rds")
df_constance_resp_div <- readRDS("Subset_depth/df_response_diversity_abundance/df_resp_div_Constance.rds")
...
```{r}
df_geneva_pred <- readRDS("Subset_depth/df_predictions_abundance/df_pred_Geneva.rds")
df_geneva_deriv <- readRDS("Subset_depth/df_derivatives_abundance/df_deriv_Geneva.rds")
df_geneva_resp_div <- readRDS("Subset_depth/df_response_diversity_abundance/df_resp_div_Geneva.rds")
...
```{r}
df_joux_pred <- readRDS("Subset_depth/df_predictions_abundance/df_pred_Joux.rds")
df_joux_deriv <- readRDS("Subset_depth/df_derivatives_abundance/df_deriv_Joux.rds")
df_joux_resp_div <- readRDS("Subset_depth/df_response_diversity_abundance/df_resp_div_Joux.rds")
...
```{r}
df_lucerne_pred <- readRDS("Subset_depth/df_predictions_abundance/df_pred_Lucerne.rds")
df_lucerne_deriv <- readRDS("Subset_depth/df_derivatives_abundance/df_deriv_Lucerne.rds")
df_lucerne_resp_div <- readRDS("Subset_depth/df_response_diversity_abundance/df_resp_div_Lucerne.rds")
...
```{r}
df_lugano_pred <- readRDS("Subset_depth/df_predictions_abundance/df_pred_Lugano.rds")
df_lugano_deriv <- readRDS("Subset_depth/df_derivatives_abundance/df_deriv_Lugano.rds")
df_lugano_resp_div <- readRDS("Subset_depth/df_response_diversity_abundance/df_resp_div_Lugano.rds")
...
```{r}
df_maggiore_pred <- readRDS("Subset_depth/df_predictions_abundance/df_pred_Maggiore.rds")
df_maggiore_deriv <- readRDS("Subset_depth/df_derivatives_abundance/df_deriv_Maggiore.rds")
df_maggiore_resp_div <- readRDS("Subset_depth/df_response_diversity_abundance/df_resp_div_Maggiore.rds")
...
```{r}
df_morat_pred <- readRDS("Subset_depth/df_predictions_abundance/df_pred_Morat.rds")
df_morat_deriv <- readRDS("Subset_depth/df_derivatives_abundance/df_deriv_Morat.rds")
df_morat_resp_div <- readRDS("Subset_depth/df_response_diversity_abundance/df_resp_div_Morat.rds")
...
```{r}
df_neuchatel_pred <- readRDS("Subset_depth/df_predictions_abundance/df_pred_Neuchatel.rds")
df_neuchatel_deriv <- readRDS("Subset_depth/df_derivatives_abundance/df_deriv_Neuchatel.rds")
df_neuchatel_resp_div <- readRDS("Subset_depth/df_response_diversity_abundance/df_resp_div_Neuchatel.rds")
...
```{r}
df_poschiavo_pred <- readRDS("Subset_depth/df_predictions_abundance/df_pred_Poschiavo.rds")
df_poschiavo_deriv <- readRDS("Subset_depth/df_derivatives_abundance/df_deriv_Poschiavo.rds")
df_poschiavo_resp_div <- readRDS("Subset_depth/df_response_diversity_abundance/df_resp_div_Poschiavo.rds")
...
```{r}
df_sarnen_pred <- readRDS("Subset_depth/df_predictions_abundance/df_pred_Sarnen.rds")
df_sarnen_deriv <- readRDS("Subset_depth/df_derivatives_abundance/df_deriv_Sarnen.rds")
df_sarnen_resp_div <- readRDS("Subset_depth/df_response_diversity_abundance/df_resp_div_Sarnen.rds")
...
```{r}
df_thun_pred <- readRDS("Subset_depth/df_predictions_abundance/df_pred_Thun.rds")
df_thun_deriv <- readRDS("Subset_depth/df_derivatives_abundance/df_deriv_Thun.rds")
df_thun_resp_div <- readRDS("Subset_depth/df_response_diversity_abundance/df_resp_div_Thun.rds")
...
```{r}
df_walen_pred <- readRDS("Subset_depth/df_predictions_abundance/df_pred_Walen.rds")
df_walen_deriv <- readRDS("Subset_depth/df_derivatives_abundance/df_deriv_Walen.rds")
df_walen_resp_div <- readRDS("Subset_depth/df_response_diversity_abundance/df_resp_div_Walen.rds")
...
```{r}
df_zug_pred <- readRDS("Subset_depth/df_predictions_abundance/df_pred_Zug.rds")
df_zug_deriv <- readRDS("Subset_depth/df_derivatives_abundance/df_deriv_Zug.rds")
df_zug_resp_div <- readRDS("Subset_depth/df_response_diversity_abundance/df_resp_div_Zug.rds")
...
```{r}
df_zurich_pred <- readRDS("Subset_depth/df_predictions_abundance/df_pred_Zurich.rds")
df_zurich_deriv <- readRDS("Subset_depth/df_derivatives_abundance/df_deriv_Zurich.rds")
df_zurich_resp_div <- readRDS("Subset_depth/df_response_diversity_abundance/df_resp_div_Zurich.rds")
