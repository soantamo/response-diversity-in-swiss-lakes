...
#3. find easy way to calculate response diversity
```
...
test3 <- readRDS("test_response/df_resp_div_Brienz.rds")
...
# ideen
select (-temp) |>
  mutate(rdiv = resp_div(sign_sens = F))
# mutate(Med = median(rdiv)
